...
def Centralized_Cellular_Network_setup(prep_delay=0, num_mem_positions=3,node_distance=100,depolar_rate=0,dephase_rate=0, 
    ...
    User_E.add_subcomponent(QuantumProcessor(
                            "User_E_QMemory", num_mem_positions, memory_noise_models=[memory_noise_model] * 3,
                             phys_instructions=physical_instructions,fallback_to_nonphysical=False))
...
#network = Centralized_Cellular_Network_setup()
